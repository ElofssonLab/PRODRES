...
#bindir="/scratch/chrisp/projects/topcons_opti/bin/cmdline/scampi-msa";
tmpdir=$1;
...
#$blastdir/bin/psiblast --num_iterations 2 -i ${infile_path}.fa -d ${infile_path}.hits.db -e 1.e-5 -v 0 -b 100 -a 4 -C ${infile_path}.chk -Q ${infile_path}.psi -m 6 -o ${infile_path}.blast  >/dev/null
...
#echo "convert"
time python convert_psi_to_prf.py ${infile_path}.psi

#/bin/echo $filename.chk > ${infile_path}.pn
#/bin/echo $filename.fa > ${infile_path}.sn
#echo "makemat"
#time $blastdir/bin/makemat -P ${infile_path}
#echo "mtx2prf"
#time $bindir/mtx2prf.pl ${infile_path}
