...
# hmmout=outdir+"/fastHMM/HMMout.txt"
 os.system("time -o "+outdir+"/fasttime.txt jackhmmer -N 3 -o /dev/null"+Bitscore+"--tblout "+outfile+" -A "+aligfile+" -Z 28332677 "+query+" "+dbfile)
 print " - end fast"
else:
...
# hmmout=outdir+"/slowHMM/HMMout.txt"
 os.system("time -o "+outdir+"/slowtime.txt jackhmmer -N 3 -o /dev/null"+Bitscore+"--tblout "+outfile+" -A "+aligfile+" -Z 28332677 "+query+" "+dbfile)
 print " - end slow"
else:
 print " - skipped, tableOut.txt already present"
