...
#echo "python pfam_scan_to_profile.py ${infile_path}.fa $tmpdir/"
 python SAVE_pfam_scan_to_profile.py ${infile_path}.fa $tmpdir $dbpath $pscan_e_val $clan_overlap $flag
#exit;
fi

# JACKHMMER
#echo 'jackbigs';
python SAVE_jackbigs.py $flag ${infile_path}.fa $tmpdir $dbpath
